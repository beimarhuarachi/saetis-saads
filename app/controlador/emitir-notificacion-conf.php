	...
	if (isset($_POST['hora']))
        {
  	    if (isset($_POST['lugar']))
            {
                $existeF = FALSE;
                $nombreF = '../documentos-cargados/asesor/NotificacionConformidad.tex';
                    ...
                    if(strnatcasecmp($nEmpresa, "Seleccione una grupo empresa")!=0)
                    {
                        ...
                        if(($DocSub == $docR) and $DocSub >= 1)
                        {
                            if(isset($_GET['id']))
                            {
                                ...
                                $ruta ="../documentos-cargados/asesor";
                                chdir($ruta);
                                ...
                                $file = "NotificacionConformidad".'_'.$nEmpresa.'.pdf';
                                   ...
                                   $nruta = "../documentos-cargados/".$nombreUGE."/NC/"."NotificacionConformidad.pdf";
                                   $fecha = date('Y-m-d');
                                   $hora  = date("G:H:i");
                                   $visible = "TRUE";
                                   $descargar = "TRUE";
