...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="sidebar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                          ...
                          <li>
                            <a href="eliminar-documento.php"><i class="fa fa-question-circle fa-fw"></i> Eliminar Documentos subidos <span class="fa arrow"></span></a>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"  >Documentos Subidos</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
