                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level collapse in">
                                    <li class="seleccionado" style="background-color:#eee">
                                        <a class="seleccionado-color" style="color:#084B8A" href="crear-modalidad-evaluacion.php">Criterio de Evaluaci&oacute;n </a>                             
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="nav nav-third-level">
                                            ...
                                            <li>
                                                <a href="sleccionar-formulario.php"> Habilitar Formulario de Evaluacion </a>   
                                            </li>
                                            <li>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="panel panel-default" id="crearModalidadEvaluacion">
                        ...
                        <form method="post" action="programacion-fechas/agregar-modalidad-evaluacion-co.php">
