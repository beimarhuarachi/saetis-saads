                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse in">
                            <li class="seleccionado" style="background-color:#eee">
                                <a class="seleccionado-color" style="color:#084B8A" href="inscripcion-proyecto.php">Registrar Proyecto</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="configuracion-rechas-recepcion.php" >Configurar Fechas para la Recepci&oacute;n de Documentos</a>
                            </li>
                            <li>
                    ...
                    <div class="panel panel-default" id="configuracionFechas">
                        <div class="panel-body"> 
                            <form method = "post" id="FormularioRegistroProyecto">
                                ...
                                <div class="form-group">
                                     <button type="submit" name="submit" class="btn btn-primary" onclick="this.form.action='registrar-proyecto.php'">  <span class="glyphicon glyphicon-ok"></span> Aceptar</button>
                                </div>
