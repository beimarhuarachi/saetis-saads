                         ...
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                 ...
                                 <li>
                                    <a href="lista-roles.php">Asignar Permisos Roles</a>
                                </li>
                                <li>
                ...
                <div class="col-lg-12">
					...
					<h2><span>Asignar Permisos</span></h2>	
							...
							?>			
								...
								<form action="crear-permisos.php" method="post">
									<center>
							...
							?>
								<div class="contenedor-fila">
									...
									<div class="contenedor-columna">
										<?php
											echo "<a href ='eliminar-permisos.php?id_us=".$fila['id_permiso']."'><font color='blue'>Eliminar</font></a>";
										?>
									</div>
