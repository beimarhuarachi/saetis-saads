    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
           ...
           <div class="sidebar-collapse">      
                ...
                <div class="sidebar-collapse">
                    <ul class="nav" id="side-menu">
                                ...
                                <li class="seleccionado" style="background-color:#eee">
                                    <a class="seleccionado-color" style="color:#084B8A" href="../vista/registro-administrador.php"><i class="fa fa-bar-chart-o fa-files-o "></i> Nueva Cuenta<span class="fa arrow"></span></a>
                                </li>                        
            ...
            <div class="col-lg-6" >
            <form id = "registroU" method = "post" action="crear-administrador.php" role="form" enctype="multipart/data-form" onsubmit="return validar(registroU)">
