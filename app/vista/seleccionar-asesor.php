                         ...
                         <li>
                            ...
                            <ul class="nav nav-second-level collapse in">
                                ...
                                <li class="seleccionado" style="background-color:#eee">
                                    <a class="seleccionado-color" style="color:#084B8A" href="seleccionar-asesor.php">Seleccionar Asesor</a>
                                </li>
                    ...
                    <div class="col-lg-4" >
                        ...
                        ?>
                            <div class="form-group">
                                <form method="POST" action="registrar-seleccion.php"><b>Asesor :</b>
