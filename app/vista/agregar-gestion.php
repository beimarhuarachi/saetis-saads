...
<body>
    ...
    <div id="wrapper">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-building-o fa-fw"></i>Tareas <span class="fa arrow"></span></a>
                                ...
                                <li class="seleccionado" style="background-color:#eee">
                                     <a class="seleccionado-color" style="color:#084B8A" href="agregar-gestion.php">Añadir  Gestion</a>
                                </li>
		...
		<form action='crear-gestion.php' method='POST'>
		...
		$peticion = $conectar->consulta("SELECT * FROM `gestion`");
			...
			<div class="contenedor-columna">
			<?php
			echo "<a href ='eliminar-gestion.php?id_us=".$fila['ID_G']."' class='verificar'><font color='blue'>Eliminar</font></a>";
			?>
			</div>
