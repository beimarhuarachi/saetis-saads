                         ...
                         <li>
                            ...
                            <ul class="nav nav-second-level collapse in">
                                 <li class="seleccionado" style="background-color:#eee">
                                     <a class="seleccionado-color" style="color:#084B8A" href="anadir-socio.php">Añadir socios</a>
                                </li>
                                 <li>
                    ...
                    <div class="col-lg-6" >
                        <form name="agregarSocio" role=form" method="post" enctype="multipart/data-form">
                            <div class="form-group">
                                ...
                                <button type="submit" onclick="this.form.action='registrar-socio.php'" class="btn btn-primary"> <span class="glyphicon glyphicon-ok"></span> Registrar</button>
