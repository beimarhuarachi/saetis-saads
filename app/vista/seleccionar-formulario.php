                                    ...
                                    <li>
                                        ...
                                        <ul class="nav nav-third-level collapse in">
                                            ...
                                            <li class="seleccionado" style="background-color:#eee">
                                                <a class="seleccionado-color" style="color:#084B8A" href="seleccionar-formulario.php"> Habilitar Formulario de Evaluacion </a>   
                                            </li>
                                            <li>
    ...
    <div class ="form-horizontal">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-lg-6">
                    <form method = "post" id="HabilitarFormulario" action="../vista/habilitar-formulario.php">   
                        <?php 
