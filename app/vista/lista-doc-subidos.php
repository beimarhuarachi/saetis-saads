                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse in">
                            ...
                            <li class="seleccionado" style="background-color:#eee">
                                <a class="seleccionado-color" style="color:#084B8A" href="lista-doc-subidos.php">Documentos Subidos </a>  
                            </li>
                            <li>
                                            ...
                                            $publicado=$con->consulta($docPubli);
                                                       ...
                                                       ?>
                                                               ...
                                                               <tr> 
                                                                    ...
                                                                    <td> 
                                                                         <?php
                                                                             echo "<a class='link-dos' href='eliminar-documento-subido.php?id_us=".$variable."'
