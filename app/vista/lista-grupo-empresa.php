...
<body>
    ...
    <div id="wrapper">
                                ...
                                <li>
                                    ...
                                    <ul class="nav nav-third-level collapse in">
                                        <li class="seleccionado" style="background-color:#eee">
                                            <a class="seleccionado-color" style="color:#084B8A" href="lista-grupo-empresa.php"> Integrantes </a>
		...
		<div id="contenido">
                ...
                <form action="lista-grupo-empresa.php" method="post"  >
		<center>
		...
		echo "<option  value='".$row["NOMBRE_U"]."'>".$row["NOMBRE_U"]."</option>";  
                ...
                <div class="contenedor-columna">
                    <?php
                            echo "<a href ='eliminar-grupo-empresa.php?id_us=".$fila['CODIGO_S']."' class='verificar'><font color='blue'>Eliminar</font></a>";
                    ?>
                </div>
