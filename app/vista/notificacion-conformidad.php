...
<head>
    ...
    <script type="text/javascript" src="../../lib/js/calendario_notacion_conformidad.js"></script>
    ...
    <script type="text/javascript" src="../../lib/js/validar_notificacion.js"></script>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse in">
                            ...
                            <li class="seleccionado" style="background-color:#eee">
                                <a class="seleccionado-color" style="color:#084B8A"href="notificacion-conformidad.php">Emitir Notificaci&oacute;n de Conformidad</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper">
            ...
            <form id = "notificacionc" method = "post" action="" role="form" enctype="multipart/data-form" onsubmit="return validarCampos(notificacionc)">
                ...
                <!--Descripcion de la publicacion-->                 
                    ...
                    <div class   ="form-group">
                      <div class   ="col-sm-8">
                         <input class ="btn btn-primary" type="submit" value= "Generar" id= "enviar" name="enviar" onclick ="this.form.action='../controlador/emitir-notificacion-conf.php?id=0'"></input> &nbsp;&nbsp;                      
                      </div>
                    </div><!--end/submit-->
