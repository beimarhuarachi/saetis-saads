                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="configuracion-fechasRecepcion.php" >Configurar Fechas para la Recepci&oacute;n de Documentos</a>
                            </li>
                            <li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="nav nav-third-level collapse in">
                                            ...
                                            <li class="seleccionado" style="background-color:#eee">
                                                <a class="seleccionado-color" style="color:#084B8A" href="eliminar-formulario.php">Eliminar Formulario de Evaluacion</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
    ...
    <div class ="form-horizontal">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-lg-6">
                    <form method = "post" id="EliminarFormulario" action="procesar-eliminar-formulario.php">   
                        ...
                        <div class="form-group">
                            ...
                            <select name="EscogidoEliminar" id="" class="form-control" required>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary" id="btn-eliminarForm"><span class="glyphicon glyphicon-trash"></span>&nbsp&nbspEliminar</button>
                                </div>                                              
                            </form>                                                
