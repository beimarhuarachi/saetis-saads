                    ...
                    <li>
                        ...
                        <ul class="nav nav-third-level collapse in">
                            <li class="seleccionado" style="background-color:#eee">
                                <a class="seleccionado-color" style="color:#084B8A" href="lista-evaluacion.php">Evaluacion 2 Fase </a>                             
                            </li>
                            <li>
                                                   ...
                                                   while($fila = mysql_fetch_array($peticion))
                                                    {
                                                        if(!empty($fila[0]))
                                                        {
                                                           ...
                                                           { $nLargoGE=$correo1["NOMBRE_LARGO_GE"];}
                                                            ...
                                                            {     if ($cantC == 0) 
                                                                    {
                                                                     ...
                                                                     $btnReportes = '<a href="reportes-evaluacion.php?GE='.$codigo.'" class="btn btn-xs btn-danger" disabled="disabled">Reportes</a>';
                                                                    }
                                                                    else
                                                                    {
                                                            ...
                                                            {
                                                            $btnEvaluacion= '<a href="evaluacion.php?GE='.$codigo.'" class="btn btn-default btn-xs" disabled="disabled">Evaluacion</a>';
                                                            $btnReportes = '<a href="reportes-evaluacion.php?GE='.$codigo.'" class="btn btn-xs btn-danger">Reportes</a>';
                                                            }
                                                            ...
                                                            if ($estado=="Retraso") 
                                                            {
                                                             $btnModificar= '<a href="modificar-fecha.php?GE='.$codigo.'" class="btn btn-default btn-xs">Modificar</a>';                       
                                                            } 
                                                            else 
                                                            {   
                                                            $btnModificar= '<a href="modificar-fecha.php?GE='.$codigo.'" class="btn btn-default btn-xs" disabled="disabled">Modificar</a>';
