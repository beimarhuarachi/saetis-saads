                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse in">
                            ...
                            <li class="seleccionado" style="background-color:#eee">
                                <a class="seleccionado-color" style="color:#084B8A" href="../vista/registrar-documentos-requeridos.php">Registrar Documentos Requeridos</a>
                            </li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default" id="configuracionFechas">
                        <div class="panel-body"> 
                            <form  method="POST" name="formulario" id="formulario" action="guardar-documento.php">
                                <p>
