                            ...
                            <ul class="nav nav-second-level collapse in">
                                ...
                                <li>
                                 ...
                                 <li class="seleccionado" style="background-color:#eee">
                                     <a class="seleccionado-color" style="color:#084B8A" href="inscripcion-grupo-proyecto.php">Inscribirse a proyecto</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        ?>
                            ...
                            <div class="form-group">
                                <form method="POST" <b>Proyectos disponibles :</b>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" name="submit" class="btn btn-primary" onclick="this.form.action='registrar-proyecto-grupo-empresa.php'">  <span class="glyphicon glyphicon-ok"></span> Aceptar</button>
                                   </div>       
                                </form>
                            </div>
                        <?php
