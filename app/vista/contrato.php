...
<div id="wrapper">
     <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse in">
                            ...
                            <li class="seleccionado" style="background-color:#eee">
                                <a class="seleccionado-color" style="color:#084B8A" href="contrato.php">Emitir Contrato </a>
                            </li>
        ...
        <div id="page-wrapper">
            ...
            Grupo Empresa:
            <form method="POST" action="emtir-contrato.php" enctype="Multipart/form-data">
                <select name="grupoempresa" class="form-control">
                 ...
                 <div class   ="col-sm-8">
                     <input class ="btn btn-primary" type="submit" value= "Generar" id= "Generar PDF" name="Generar PDF" onclick ="this.form.action='../controlador/emitir-contrato.php?id=0'"></input> &nbsp;&nbsp;              
