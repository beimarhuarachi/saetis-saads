...
<head>
    ...
    <script type="text/javascript" src="../../lib/js/validar_orden.js"></script>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse in">
                            ...
                            <li class="seleccionado" style="background-color:#eee">
                                <a class="seleccionado-color" style="color:#084B8A" href="orden-de-cambio.php">Emitir Orden de Cambio</a>
                            </li>
                            <li >
        ...
        <div id="page-wrapper">
            ...
            <form id = "ordenc" method = "post" action="" role="form" enctype="multipart/data-form" onsubmit="return validarCampos(ordenc)">
                ...
                <!--Descripcion de la publicacion-->                 
                    ...
                    <div class   ="form-group">
                      <div class   ="col-sm-8">
                         <input class ="btn btn-primary" type="submit" value= "Generar" id= "enviar" name="enviar" onclick ="this.form.action='../controlador/orden-de-cambio.php?id=0'"></input> &nbsp;&nbsp;                      
                      </div>
                    </div><!--end/submit-->
                 </div> 
            </form>  
