                        ...
                        ?>
                            ...
                            <div class="form-group">
                                <form method="POST" <b>Proyectos disponibles :</b>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" name="submit" class="btn btn-primary" onclick="this.form.action='registrar-proyecto-GE.php'">  <span class="glyphicon glyphicon-ok"></span> Aceptar</button>
                                   </div>       
                                </form>
                            </div>
                        <?php
