            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="modificar-asesor.php"><i class="fa fa-user fa-fw"></i> Modificar Datos personales</a>
                        </li>
                        <li class="divider"></li>
            ...
            <div class="navbar-default navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="administrar-grupo-empresa.php"><i class="fa fa-book"></i> Administrar Grupo Empresas</a>
                        </li>
                        <li>
                        ...
                        <li>
                         ...
                         <li>
                              <a href="lista-doc-subidos.php"><i class="fa fa-tasks fa-fw"></i>Documentos Subidos </a>  
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="col-lg-12">
                        ...
                        <form action="../vista/procesar-firma-contrato.php" method="POST">
