$(document).on('ready',function(){
    ...
    $('#horaFinalE').datetimepicker({
     ...
     $('#documentoRequerido').on('change',function(e){
        ...
        **/
        $.ajax({
              url:"forms/actions/recargar-fechas.php",
              type: "POST",
...
function evaluarFecha2(fecha1) {
	...
	$("#fechaFinalE").datetimepicker({
                ...
                format:'Y-m-d',
                formatDate:'Y/m/d',
                minDate:y, // fecha actual es el minimo de seleccion en fechas
                z:'+1970/04/01' // and tommorow is maximum date calendar
	});
}**/
/**
