                        ...
                        <div class="panel-body"> 
                                   ...
                                   ?>       
                                    ...
                                    <form method = "post" id="FormularioRegistroUsuarioGE">
                                        ...
                                        <div class="form-group">
                                             <button type="submit" name="submit" class="btn btn-primary" onclick="this.form.action='modificar-GE.php'">  <span class="glyphicon glyphicon-ok"></span> Actualizar</button>
                                        </div>
