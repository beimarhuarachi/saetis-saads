    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../vista/inicio-asesor.php">Inicio </a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="../vista/modificar-asesor.php"><i class="fa fa-user fa-fw"></i> Modificar Datos personales</a>
                        </li>
                        <li class="divider"></li>
            ...
            <div class="navbar-default navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="../vista/administrar-grupo-empresa.php"><i class="fa fa-book"></i> Administrar Grupo Empresas</a>
                        </li>
                        <li>
                                        <a href="#"><i class="glyphicon glyphicon-th-list"></i> Evaluacion Grupo Empresa<span class="fa arrow"></span></a>
                                            <ul class="nav nav-third-level">
                                                <li>
                                                    <a href="../vista/crear-modalidad-evaluacion.php">Criterio de Evaluaci&oacute;n </a>                             
                                                </li>
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="nav nav-third-level">
                                                        <li>
                                                            <a href="../vista/crear-modalidad-calificacion.php"> Crear Criterio de Calificaci&oacute;n</a>
                                                        </li>
                                                        <li>
                                                            <a href="../vista/eliminar-criterio-calificacion.php"> Eliminar Criterio de Calificaci&oacute;n</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="nav nav-third-level">
                                                        <li>
                                                            <a href="../vista/crear-formulario.php">Crear Formulario de Evaluacion</a>
                                                        </li>
                                                        <li>
                                                            <a href="../vista/seleccionar-formulario.php"> Habilitar Formulario de Evaluacion </a>   
                                                        </li>
                                                        <li>
                                                            <a href="../vista/eliminar-formulario.php">Eliminar Formulario de Evaluacion</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    <a href="../vista/evaluar-grupo-empresa.php">Evaluar Grupo Empresa </a>   
                                                </li>
                                                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    ...
                                    <ul class="nav nav-third-level">
                                        <li>
                                            <a href="../vista/documentos-recibidos.php">Documentos Recibidos</a>
                                        </li>
                                        <li>
                                            <a href="../vista/configuracion-fechas-recepcion.php" ><span class="fa fa-calendar-o"></span> Configuraci&oacute;n de Fechas para la Recepci&oacute;n de Documentos</a>
                         ...
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="../vista/registrar-firma.php">Firma de Contratos</a>
                                </li>
                                <li>
                                    <a href="../vista/orden-de-cambio.php">Emitir Orden de Cambio</a>
                                </li>
                                <li>
                                    <a href="../vista/notificacion-conformidad.php">Emitir Notificaci&oacute;n de Conformidad</a>
                                </li>
                                <li>
                                    <a href="../vista/inscripcion-proyecto.php">Registrar Proyecto</a>
                                </li>
                                <li>
                         ...
                         <li>
                              <a href="../vista/lista-doc-subidos.php"><i class="fa fa-tasks fa-fw"></i>Documentos Subidos </a>  
                        ...
                        <form id = "publicar" method = "POST" action="" onsubmit = "return validarCampos(this);">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-footer">
                                    <a href="../vista/publicar-asesor.php" class="link" ><i class="fa fa-plus "></i> Agregar recurso<span class="fa arrow"></span></a>
                                </div>
                            </div>
                        </form>
                    </div><!-- /.col-lg-12 -->
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
   ...
   <script src="../lib/js/jquery-1.10.2.js"></script>
    ...
    <script src="../js/lib/demo/dashboard-demo.js"></script>
