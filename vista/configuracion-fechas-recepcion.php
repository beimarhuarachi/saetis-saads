...
include 'forms/actions/seleccionar-documento-configuracion-fechas.php';
 ?> 
 <!DOCTYPE html>
 <html>
 ...
 <head>
    ...
    <script type="text/javascript" src="js/validacion-campos-fecha.js"></script>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default" id="configuracionFechas">
                    ...
                    <div class="panel-body">
                        ...
                        <form  method="POST" name="formulario" id="formulario" action="forms/actions/configurar-fecha-recepcion-co.php" > 
              ...
              //include 'forms/actions/configurar-fecha-recepcion-co.php';
              error_reporting (5);  
                                 ...
                                 <script type="text/javascript">
                                    ...
                                    $('#fechaFinalE').on('click', function(){
                                        var x = $('#fechaInicioE').val();
                                            $.getScript('js/validacion-campos-fecha.js',function(){
                                                evaluarFecha2(x);
                                              });
                                    });
